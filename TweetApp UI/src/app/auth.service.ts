...
export class AuthService{
    ...
    signUp(userDetail: User){
        return this.http.post('https://tweetappapimegha.azurewebsites.net/api/v1.0/tweets/register', userDetail);
    }

    login(emailId: string, password: string){
        return this.http.post<ViewUser>('https://tweetappapimegha.azurewebsites.net/api/v1.0/tweets/login', {
            emailId: emailId,
            password: password
    ...
    SecurityCheckValidation(emailId: string, question: number, answer: string){
        return this.http.put<boolean>('https://tweetappapimegha.azurewebsites.net/api/v1.0/tweets/forgot', {
            emailId : emailId,
    ...
    resetPassword(userId: string, newPassword: string){
        return this.http.put<boolean>('https://tweetappapimegha.azurewebsites.net/api/v1.0/tweets/reset/'+userId,
        {
